...
You can either use the demo server mentioned above or the Neo4j AuraDB Free, Neo4j Sandbox or Cloud Marketplaces shown <<other-setups,below>>
 ...
 * Log in to https://console.neo4j.io/?ref=developer-pages[Neo4j AuraDB Free].
 * Proceed to the database creation page
 * Choose AuraDB Free
 * Select a region near you
 * Pick the movies database
 * Confirm and save the credentials
 * Wait until the database is started and also save the connection URL
